...
mkdir -p output/qwen2.5-7b-instruct_lora_digestive_3716_9to1
mkdir -p logs
...
CUDA_VISIBLE_DEVICES=1 conda run -n qwen_sft swift sft \
  ...
  --output_dir /mnt/public/zxs/course/SFT_qwen/output/qwen2.5-7b-instruct_lora_digestive_3716_9to1 \
