...
mkdir -p output/qwen2.5-3b-instruct_lora_digestive_3716_9to1_half3090
mkdir -p logs

# "Half 3090" is approximated by conservative sequence length and accumulation.
CUDA_VISIBLE_DEVICES=0 conda run -n qwen_sft swift sft \
  ...
  --output_dir /mnt/public/zxs/course/SFT_qwen/output/qwen2.5-3b-instruct_lora_digestive_3716_9to1_half3090 \
